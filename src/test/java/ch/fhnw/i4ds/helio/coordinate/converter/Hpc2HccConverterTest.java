...
public class Hpc2HccConverterTest {
	...
	public void convert_default_options() {
		HelioprojectiveCartesianCoordinate hpc = new HelioprojectiveCartesianCoordinate(40.0, 32.0);
	...
	public void convert_custom_sun_distance() {
		HelioprojectiveCartesianCoordinate hpc = 
						new HelioprojectiveCartesianCoordinate(40.0, 32.0, Constants.AU.getValue() / 2);
		HeliocentricCartesianCoordinate hcc = converter.convert(hpc);
    ...
    public void convert_list() {
    	HelioprojectiveCartesianCoordinate hpc1 = new HelioprojectiveCartesianCoordinate(34.0, 96.0);
    	HelioprojectiveCartesianCoordinate hpc2 = new HelioprojectiveCartesianCoordinate(55.0, 56.0);
